...
from h2o.serializers import write_with_length, write_int, read_long, \
...
def x_worker_main(infile, outfile):
    try:
        boot_time = time.time()
        ...
        try:
            ...
            print("H2O worker failed with exception:", file=sys.stderr)
